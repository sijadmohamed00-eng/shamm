...
const DB={
  ...
  set(k,v){localStorage.setItem('ccs2_'+k,JSON.stringify(v));if(typeof SYNC_KEYS!=='undefined'&&SYNC_KEYS.includes(k)&&typeof _syncToCloud==='function')_syncToCloud(k,v);},
  del(k){localStorage.removeItem('ccs2_'+k)}
};
