...
// ═══ DB — تعريف قاعدة البيانات المحلية هنا لضمان التحميل أولاً ═══
var DB = {
get: function(k){ try{ return JSON.parse(localStorage.getItem(‘ccs2_’+k)); }catch(e){ return null; } },
set: function(k,v){ localStorage.setItem(‘ccs2_’+k, JSON.stringify(v)); if(typeof SYNC_KEYS!==‘undefined’ && SYNC_KEYS.includes(k) && typeof _syncToCloud===‘function’) *syncToCloud(k,v); },
del: function(k){ localStorage.removeItem(’ccs2*’+k); }
};
window.DB = DB;

// ═══ GLOBAL VARIABLES — معرّفة هنا لضمان التوفر لجميع الملفات ═══
var CU = null;
var SA_MODE = false;
var CU_PERMS = null;
var DID = null;
